    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link waves-effect active grey darken-3 rounded rounded-2" href="/about">Обо мне<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          <div class="card">
            ...
            <div class="card-body">
              <p class="lead">
              Салют! Меня зовут Кирилл Кузьмин, и ты попал в мой криптоблог!<br>
              <br>
              Сейчас я сколотил себе хороший портфель и стараюсь не обналичивать криптовалюту, а зарабатывать на ней. Точную сумму говорить не буду, но признаюсь: есть у меня несколько десятков тысяч долларов на черный день.<br>
              <br>
              Не буду скрывать, пока я набивал шишки в этой сфере, достаточно посливал. Например, свой первый Биткоин я закупил на хаях в 2016, после чего курс пошел вниз.<br>
              <br>
              Чуть позже я увлекся трейдингом, начал изучение самостоятельно, потом прошел много платных курсов (не все из них были действительно полезными). В общем, методом «проб и ошибок» я обрел те знания и навыки, которыми теперь делюсь с вами.<br>
              <br>
              Нет, я не инвестировал в крипту последние деньги, и я не расскажу вам историю о том, как криптовалюта спасла мою жизнь. Я просто понимаю, что многие новички сейчас сталкиваются с теми же проблемами, которые были у меня вначале, потому что не хватает качественной информации!<br>
              <br>
              Я помогу вам не облажаться в первые же дни на рынке цифровых валют и первым расскажу обо всех событиях индустрии, про которые не скажут по ТВ!
              </p>
            </div>
          </div>
        </div>
